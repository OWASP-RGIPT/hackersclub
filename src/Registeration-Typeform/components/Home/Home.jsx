      ...
      <div className={styles.container}>
        <div className={styles.text}>
          ...
          <p className={styles.content}>
            ...
            <br />
            <br />
            <span>We strongly advise you to read and understand all the <a href="/t&c" target='blank'>terms and conditions</a> meticulously. Your informed consent is essential before you proceed.</span>
          </p>
        </div>
